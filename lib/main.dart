...
class PatientProfile {
  ...
  String communicationStyle = "Short & simple";
    ...
    return AppState(
      child: Scaffold(
        ...
        bottomNavigationBar: NavigationBar(
          ...
          destinations: const [
            NavigationDestination(icon: Icon(Icons.mic_rounded), label: 'Home'),
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void didChangeDependencies() {
    ...
    _listener = ContinuousListener(
      ...
      onSuggestions: ({required String transcript, required List<String> options}) {
        ...
        final simple = options.take(2).map((s) {
          final t = s.trim();
          if (t.length <= 24) return t;
          final cut = t.split(RegExp(r'[.,;:!?]')).first;
          return cut.length <= 24 ? cut : cut.substring(0, 24).trim();
        }).toList();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Aphasia Helper — ${app.profile.name}"),
        centerTitle: true,
        actions: [
              ...
              children: [
                  ...
                  onPressed: () async {
                    ...
                    if (turnOn) {
                      ...
                      if (!ok) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('Need microphone permission'),
                          ),
                        );
                        return;
                      }
                    ...
                    final status =
                        app.listeningOn ? "Listening" : "Not listening";
                    if (!mounted) return;
                ...
                _InfoCard(
                  ...
                  child: const Text(
                    ...
                    "3. You’ll see 1–2 big buttons.\n"
                    "4. Tap the one you want.\n"
                    "Your voice is not saved.",
...
class _ListeningStatusPill extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final label = on ? "Listening" : "Not listening";
    return Container(
...
class _PatientScreenState extends State<PatientScreen> {
  ...
  TextEditingController? caregiverCtrl;
  ...
  void didChangeDependencies() {
    ...
    caregiverCtrl = TextEditingController(text: p.caregiverName);
          ...
          IconButton(
            onPressed: () {
              ...
              setState(() {
                ...
                p.caregiverName = caregiverCtrl!.text.trim();
          ...
          _Section(
            ...
            children: [
              TextField(
                ...
                maxLines: 5,
                decoration: const InputDecoration(
                  labelText: "Things we should know",
